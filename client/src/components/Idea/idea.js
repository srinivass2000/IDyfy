    ...
    return(
        <div>
            ...
            <div className="relative flex justify-center">
                 <div className="absolute top-1/3 sm:text-xl md:text-4xl lg:text-6xl" style={{color:'white'}}>{idea.title}</div>
             ...
             <div className="container">
                 <div className="row">
                   ...
                   <div className="col-md-8 pr-3 pl-3" >
                       <p className="p-4" style={{backgroundColor:"#ffffff", borderRadius:"20px"}}>{idea.description}</p>
                   </div>
                   ...
                   <div className="mt-3 text-start col-md-1 col-1" style={{color:"white"}}>{comments.length}</div>
                 </div>
                 <div className="row"> 
                 ...
                 <div className="row"> 
                     ...
                     <div className="col-md-2 p-3 mt-3 " >
                         {
                            idea.tags.map((tag,i)=>
                              <a key={i} className="m-3" style={{color:"white"}} href="/">#{tag.replace(/ /g,'')}</a>
                            )
                         }
                     </div>
                 </div>
