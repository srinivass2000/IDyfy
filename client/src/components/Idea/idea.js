    ...
    return(
        <div>
            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-md-4">
                        <button className="btn pl-3 pr-3 mb-3 mt-3" style={{ "background-color": "#F62F08", color: "white", fontSize:"1.7rem", borderRadius:"1.2rem", fontWeight:"500" }}>
                            View Graph
                        </button>
                    </div>
                </div>
