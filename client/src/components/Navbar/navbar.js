  ...
  return (
    <div>
      ...
      {{ backgroundColor : "#B287FF"}}>
        ...
        <div className="flex-auto pt-5 ml-3"><img src={Idyfy_name} alt="IDYFY NAME"/></div>
        ...
        <div className="flex-auto flex flex-col">
          <Link to="/">
          <div className="flex justify-center pt-5"><img src={home} alt="home"/></div>
          <div className="pt-3"><h6>Home</h6></div>
          </Link>
        </div>
        <div className="flex-auto flex flex-col">
          <div className="flex justify-center pt-5"><img src={new_idea} alt="New Idea"/></div>
        ...
        <div className="flex-auto flex flex-col">
        <Link to="/starred">
          <div className="flex justify-center pt-5"><img src={starred} alt="Starred Ideas"/></div>
          <div><h6>Starred Ideas</h6></div>
          </Link>
        </div>
        <div className="flex-auto flex flex-col">
        <Link to="/notifiction">
          <div className="flex justify-center pt-5"><img src={notifications} alt="Notifications"/></div>
