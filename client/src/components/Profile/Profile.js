        ...
        <div>
            ...
            <div className="offset-lg-1 col-lg-10 shadow-lg p-3 rounded color ">
              ...
              <div className="row pb-2 border-bottom">
                <div className=" col-lg-2 col-md-2">
                  <div className="flex justify-center">{user.ideas_contributed.length}</div>
              ...
              <div className="row mt-10 flex justify-center">
                <div className="name" style={{fontSize:"x-large"}}>{user.name}</div>
                <div className="post" style={{fontSize:"x-large"}}>N.A(job)</div>
                <div className="university" style={{fontSize:"x-large"}}>N.A(university)</div>
              </div>{" "}
          ...
          <div className="container ">
            <div className="row mt-4">
              <div className="fs-3 offset-lg-1 col-lg-2 offset-1 col-5 white border-radius rounded">
                  <Link to={{
                      pathname:url + user._id,
                      state:{user}
                          }}>
